        ...
        <div className="flex items-center justify-end gap-1">
          ...
          {showConnectionSettings ? (
            <div className="relative z-[210]" ref={menuRef}>
              ...
              {menuOpen ? (
                <div className="ui-card ui-menu-popover absolute right-0 top-9 z-[260] min-w-52 p-1">
                  <Link
                    className="ui-btn-ghost flex w-full items-center justify-start border-transparent px-3 py-2 text-left text-xs font-medium tracking-normal text-foreground"
