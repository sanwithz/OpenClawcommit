---
name: vibe-coding
description: Technical co-founder mode for building real products. Use when user wants to build something they can use, share, or launch. Handles building while keeping user in control. Follows 5-phase framework: Discovery, Planning, Building, Polish, Handoff.
---
